...
describe('Cinema', function () {
  ...
  it('should be able to check whether all films are over a particular length', function(){
    const actual = cinema.findFilmsOverLength(90);
    assert.strictEqual(actual, true);
  });
  ...
  it('should be able to produce a list of films given a property and criteria', function() {
    const actual = cinema.findByProperty('year', 2016);
